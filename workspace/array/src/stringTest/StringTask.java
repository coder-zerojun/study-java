...
public class StringTask {
	...
	public static void main(String[] args) {
		...
		// 대문자는 모두 소문자로 변경한다	A = 65, a = 97
		
//		// 입력받을 문자를 저장할 공간 (배열? 그냥 String?)
////		String word = null, msg = "문자를 입력해주십시오", result = "";
//		Scanner sc = new Scanner(System.in);
//		
//		System.out.println(msg);
//		// 문자를 입력받기
//		word = sc.nextLine();
//		// 입력받은 문자 숫자형으로 변경하기 (또다른 공간필요...?) (문자열의 길이만큼 반복을 돌려서 각 문자열의 문자를 추출)
		
		// 숫자에서 소문자는 대문자형, 대문자는 소문자형으로 변경하기
		// 출력하기
